    ...
    <el-space direction="vertical" alignment="left" style="width: 100%">
      ...
      <el-row :gutter="20">
        <el-col :span="4" v-for="(item,index) in listData">
          <el-card shadow="hover" :style="index>5 ? { marginTop: '10px',cursor: 'pointer' } : 'cursor: pointer'"  @click="router.push('/productDetails/'+item.id)">
            <template #header>
    ...
    >
      <el-form ref="formRef" :model="formData" label-width="100px">
          ...
          <el-form-item label="介绍" prop="introduce">
            <MyEditor :content="formData.introduce" @content-change="formData.introduce =$event"
