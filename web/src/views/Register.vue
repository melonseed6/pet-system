      ...
      <el-space direction="vertical" style="width: 100%" size="large">
        <el-space>
          ...
          <el-space direction="vertical" style="width: 100%" size="small">
            <h2 style="font-style: oblique">宠物商店服务平台</h2>
            <span style="font-style: oblique;font-size: 10px">Pet shop service platform</span>
          </el-space>
        </el-space>
        <el-form :model="formData" label-width="80px" ref="formRef" style="width: 100%" inline>
          ...
          <el-form-item label="" style="width: 100%">
            <el-space direction="vertical" alignment="left" style="width: 100%">
              ...
              <router-link tag="span" :to="{path:'login'}">
                <span type="text" class="button" style="float: right">已有账号？去登录</span>
              </router-link>
            </el-space>
