...
public class HelpMessageController {
     ...
     */
    @GetMapping("page")
    public ResponseVO<PageVO<HelpMessage>> page(@RequestParam Map<String, Object> query, @RequestParam(defaultValue = "1") Integer pageNum, @RequestParam(defaultValue = "10") Integer pageSize) {
